...
Download the SemanticRT dataset ([Google Drive](https://drive.google.com/file/d/1KXgqYLy-yQBLAzhXY1zusVQiQ27Gr0Uw/view?usp=sharing)), which is structured as follows:
...
First download the SemanticRT [dataset](https://drive.google.com/file/d/1KXgqYLy-yQBLAzhXY1zusVQiQ27Gr0Uw/view?usp=sharing). Then the model can be used in just a few adaptions to start training: 
...
Meanwhile, the segmentation maps can be generated by loading our pre-trained model [checkpoint](https://drive.google.com/file/d/1HRInuLg11obz8zUxpSldl-a1uegiXwpt/view?usp=sharing), with: 
